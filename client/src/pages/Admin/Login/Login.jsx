import { Alert, AlertDescription, AlertIcon, Box, Button, Checkbox, FormControl, Input, InputGroup, InputRightElement } from '@chakra-ui/react'
...
const Login = ({ decodedToken, isExpired }) => {
  ...
  return (
    <Box height='100vh'>
      ...
      <Box w={'100%'} h={'8rem'} bg={'blue.900'} position={'relative'} bottom={'0'}>
